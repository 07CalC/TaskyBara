    ...
    return (
        <div className="w-full flex flex-col px-5">
            <div className="self-start text-start w-full flex flex-col gap-y-4 ">
                <Link href="/console/dashboard" className="w-full"><div className={`cursor-pointer ${route === "dashboard" ? "bg-primaryLight dark:bg-secondaryDark" : ""} text-xl font-bold p-5 rounded-xl text-black dark:text-white flex gap-x-2`} onClick={() => setRoute("dashboard")}>
                ...
                <Link href="/console/projects" className="w-full">
